...
#          load('enrichment_tables.Rdata')
#          enrichment_tables_with_additional_metrics <- add_metrics_to_enrichment_tables(enrichment_tables,
...
#          expect_equal(length(enrichment_tables$LT$'GO Cellular Component') + 19, 
